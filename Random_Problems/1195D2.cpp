		...
		rep(i, 11){
			...
			if (digits<=i+1)
			{
				...
				while(num!=0){
					if (flagg%2==0)
					{
						newNum+=(num%10)*poww(10, flagg, 998244353);
						num = num/10;
					}
					flagg++;
				}
			...
			trace(elem, i, digits, newNum, freq);
			...
			if (digits<=i)
			{
				...
				while(num!=0){
					if (flag%2!=0)
					{
						newNum+=(num%10)*poww(10, flag, 998244353);
						num = num/10;
					}
					flag++;
				}
